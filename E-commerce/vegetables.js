document.addEventListener("DOMContentLoaded", () => {
    ...
    const isLoggedIn = localStorage.getItem('user'); // Assuming 'user' is set on login
    ...
    checkoutBtn.addEventListener("click", () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Redirect or open payment page/modal
                console.log("Proceeding to payment with amount:", total);
                window.location.href = "checkout.html"; // or show your own modal
            }
        });
    });
}
